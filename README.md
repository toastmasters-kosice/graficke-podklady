...
# Grafické podklady [![alt_text][fb_icon]][fb_page]
Logá, ikony, bannery, screenshoty k návodom a procesom a ďalšie podklady klubu [Toastmasters Košice][tm-kosice-website]. V iných dokumentoch sa budeme odkazovať na tento repozitár. Aktualizáciou obrázka sa zmena okamžite prejaví.
